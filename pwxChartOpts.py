...
class pwxChartParms(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.label_ctrl_trace = wx.StaticText(self, -1, "", style=wx.ALIGN_RIGHT | wx.EXPAND)
	...
	def __do_layout(self):
		...
		sizer_3.Add(self.label_ctrl_trace, 1, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
		...
		sizer_4.Add(self.slider_ctrl_linewd, 1, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
		...
		sizer_5.Add(self.slider_ctrl_marker, 1, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
