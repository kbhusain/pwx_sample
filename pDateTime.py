...
class Date(object):
	...
	def __str__(self):
		return "%d-%s-%d" % (self.day,Date.Months[self.month - 1],self.year)
...
if __name__ == "__main__":
	...
	print "Difference ",  str(temp), " and ", str(temp2), " is ", temp2 - temp
	print "Difference ",  str(temp), " and ", str(temp3), " is ", temp3 - temp
